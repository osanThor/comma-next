...
export default function GameBanner({ gameName }: Props) {
  return (
    <div
      className="col-span-4 w-full h-[404px] rounded-2xl bg-main-500 flex flex-col relative"
      style={{
    ...
    >
      <div
        className={twMerge(
          "absolute right-[0px] flex flex-col items-start gap-5 top-1/2 translate-y-5",
          gameName === "tetris" ? "top-[126px]" : "top-[96px]"
        )}
      >
        <h1 className="text-6xl font-bold font-pixelNes text-white w-[367px] whitespace-pre-line">
        ...
        >
          ...
          <p className="font-dnf text-lg">PLAY GAME</p>
        </Link>
      </div>
    </div>
  );
